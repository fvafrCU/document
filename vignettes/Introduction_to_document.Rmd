...
You can view a copy of the html file [here](http://htmlpreview.github.io/?https://github.com/fvafrCU/excerptr/blob/master/inst/tests/files/simple.html), the pdf file looks accordingly.
