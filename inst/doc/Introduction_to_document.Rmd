...
This is exactly what this package is about: run roxygen2 on (chunks of) a single 
code file.
...
code file. So we can use **R CMD check --as-cran** to see if your code and
